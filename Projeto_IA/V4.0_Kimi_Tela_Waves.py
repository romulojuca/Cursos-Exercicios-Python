...
right_frame = tk.Frame(root, bd=1, highlightthickness=0)
right_frame.pack(pady=5)

wave_canvas = tk.Canvas(right_frame, width=700, height=20,
                        bg="#75A5CA", bd=1, highlightthickness=0)
wave_canvas.pack(pady=0)
