...
recognizer.pause_threshold = 2.0  # espera até 2s de silêncio
...
while True:
    ...
    recent_history = history[-max_history*2:]  # mantém histórico limitado

    # --- INSTRUÇÕES OTIMIZADAS ---
    instructions = f"""
    System role:
    You are an English teacher AI for {user_level} English level.
    Your tasks:
    1. Use simple English according to the user level.
    2. Do not correct the punctuation "." "," ";" ":". 
    3. 
    4. If the user makes any mistakes in vocabulary, grammar or context, correct them carefully in one setence.
    5. Always answer User questions and end your response with a follow-up question.
    """
